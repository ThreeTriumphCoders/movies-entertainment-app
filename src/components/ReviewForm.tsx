    ...
    <form className='sm:mb-12 mb-8' onSubmit={handleSubmit}>
      <label className='mr-4 sm:mr-6 relative'>
        ...
        <input
          ...
          className={classNames(
            'bg-dark caret-primary outline-none border-b border-b-grey focus:border-b-light placeholder:text-light placeholder:opacity-50 placeholder:text-sm pb-3 focus:pl-9 sm:focus:pl-14 sm:pb-3 transition-all w-1/3 font-body font-light',
            { 'pl-9 sm:pl-14': query }
          )}
